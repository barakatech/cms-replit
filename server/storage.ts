...
// Seed Crypto Pages
const seedCryptoPages: CryptoPage[] = [
  {
    id: 'crypto-btc',
    symbol: 'BTC',
    name: 'Bitcoin',
    ...
    heroSummary_en: 'Bitcoin is the first and largest cryptocurrency by market capitalization.',
    heroSummary_ar: 'البيتكوين هي أول وأكبر عملة رقمية من حيث القيمة السوقية.',
    whatIsIt_en: '<p><strong>Bitcoin (BTC)</strong> is a decentralized digital currency that operates without a central bank or single administrator. It was invented in 2008 by an unknown person or group using the name Satoshi Nakamoto.</p><p>Bitcoin uses peer-to-peer technology to facilitate instant payments. Transactions are verified by network nodes through cryptography and recorded in a public distributed ledger called a blockchain.</p>',
    whatIsIt_ar: '<p><strong>البيتكوين (BTC)</strong> هي عملة رقمية لامركزية تعمل بدون بنك مركزي أو مسؤول واحد. تم اختراعها في عام 2008 من قبل شخص أو مجموعة مجهولة باستخدام اسم ساتوشي ناكاموتو.</p>',
    howItWorks_en: '<p>Bitcoin utilizes blockchain technology to record all transactions on a public ledger. Transactions are validated by miners using proof-of-work consensus.</p>',
    howItWorks_ar: '<p>تستخدم البيتكوين تقنية البلوكتشين لتسجيل جميع المعاملات على دفتر عام.</p>',
    risks_en: '<p><strong>Important Risk Disclosures:</strong></p><ul><li><strong>Market Volatility:</strong> Cryptocurrency prices can fluctuate significantly.</li><li><strong>Regulatory Risk:</strong> Regulations vary by jurisdiction and may change.</li><li><strong>Loss of Capital:</strong> You may lose some or all of your invested capital.</li></ul>',
    risks_ar: '<p><strong>إفصاحات المخاطر المهمة:</strong></p><ul><li>يمكن أن تتقلب أسعار العملات الرقمية بشكل كبير.</li></ul>',
    disclaimers_en: ['This page is for information only and is not investment advice.'],
    disclaimers_ar: ['هذه الصفحة لأغراض معلوماتية فقط وليست نصيحة استثمارية.'],
    metaTitle_en: 'Bitcoin (BTC) Price, Charts & Market Data | baraka',
    metaTitle_ar: 'سعر البيتكوين (BTC) والرسوم البيانية | بركة',
    metaDescription_en: 'Get the latest Bitcoin price, market cap, and trading volume.',
    metaDescription_ar: 'احصل على أحدث سعر البيتكوين والقيمة السوقية.',
    createdAt: now,
    updatedAt: now,
  } as CryptoPage,
  {
    ...
    complianceStatus: 'pass',
    requiredDisclosuresPresent: true,
    heroSummary_en: 'Ethereum is the leading smart contract platform and second-largest cryptocurrency.',
    heroSummary_ar: 'الإيثريوم هي منصة العقود الذكية الرائدة وثاني أكبر عملة رقمية.',
    whatIsIt_en: '<p><strong>Ethereum (ETH)</strong> is a decentralized blockchain platform that enables smart contracts and decentralized applications (dApps).</p>',
    whatIsIt_ar: '<p><strong>الإيثريوم (ETH)</strong> هي منصة بلوكتشين لامركزية تمكّن العقود الذكية والتطبيقات اللامركزية.</p>',
    howItWorks_en: '<p>Ethereum uses proof-of-stake consensus to validate transactions and secure the network.</p>',
    howItWorks_ar: '<p>تستخدم الإيثريوم إجماع إثبات الحصة للتحقق من المعاملات وتأمين الشبكة.</p>',
    risks_en: '<p><strong>Important Risk Disclosures:</strong></p><ul><li><strong>Market Volatility:</strong> Cryptocurrency prices can fluctuate significantly.</li><li><strong>Smart Contract Risk:</strong> Smart contracts may contain bugs.</li></ul>',
    risks_ar: '<p><strong>إفصاحات المخاطر المهمة:</strong></p><ul><li>يمكن أن تتقلب أسعار العملات الرقمية بشكل كبير.</li></ul>',
    disclaimers_en: ['This page is for information only and is not investment advice.'],
    disclaimers_ar: ['هذه الصفحة لأغراض معلوماتية فقط وليست نصيحة استثمارية.'],
    metaTitle_en: 'Ethereum (ETH) Price, Charts & Market Data | baraka',
    metaTitle_ar: 'سعر الإيثريوم (ETH) والرسوم البيانية | بركة',
    metaDescription_en: 'Get the latest Ethereum price, market cap, and trading volume.',
    metaDescription_ar: 'احصل على أحدث سعر الإيثريوم والقيمة السوقية.',
    createdAt: now,
    updatedAt: now,
  } as CryptoPage,
  {
    ...
    complianceStatus: 'pass',
    requiredDisclosuresPresent: true,
    heroSummary_en: 'Tether (USDT) is the largest stablecoin pegged to the US Dollar.',
    heroSummary_ar: 'تيثر (USDT) هي أكبر عملة مستقرة مرتبطة بالدولار الأمريكي.',
    whatIsIt_en: '<p><strong>Tether (USDT)</strong> is a stablecoin pegged to the US Dollar, designed to maintain a 1:1 ratio with USD.</p>',
    whatIsIt_ar: '<p><strong>تيثر (USDT)</strong> هي عملة مستقرة مرتبطة بالدولار الأمريكي.</p>',
    howItWorks_en: '<p>Tether is backed by reserves and maintains its peg through reserve management.</p>',
    howItWorks_ar: '<p>تيثر مدعومة بالاحتياطيات وتحافظ على ارتباطها من خلال إدارة الاحتياطيات.</p>',
    risks_en: '<p><strong>Important Risk Disclosures:</strong></p><ul><li><strong>Reserve Risk:</strong> The stability depends on the backing reserves.</li><li><strong>Regulatory Risk:</strong> Stablecoins face regulatory scrutiny.</li></ul>',
    risks_ar: '<p><strong>إفصاحات المخاطر المهمة:</strong></p><ul><li>يعتمد الاستقرار على الاحتياطيات الداعمة.</li></ul>',
    disclaimers_en: ['This page is for information only and is not investment advice.'],
    disclaimers_ar: ['هذه الصفحة لأغراض معلوماتية فقط وليست نصيحة استثمارية.'],
    metaTitle_en: 'Tether (USDT) Price, Charts & Market Data | baraka',
    metaTitle_ar: 'سعر تيثر (USDT) والرسوم البيانية | بركة',
    metaDescription_en: 'Get the latest Tether price and market information.',
    metaDescription_ar: 'احصل على أحدث سعر تيثر ومعلومات السوق.',
    createdAt: now,
    updatedAt: now,
  } as CryptoPage,
];
...
export class MemStorage implements IStorage {
  ...
  constructor() {
    ...
    this.cryptoPages = new Map(seedCryptoPages.map(c => [c.id, c]));
