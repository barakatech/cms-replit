...
const seedStockPages: StockPage[] = [
  ...
  { id: '8', ticker: 'AMD', slug: 'amd-amd', companyName_en: 'Advanced Micro Devices, Inc.', companyName_ar: 'شركة أدفانسد مايكرو ديفايسز', description_en: 'AMD designs microprocessors and GPUs for computing and graphics markets.', description_ar: 'AMD تصمم المعالجات الدقيقة ووحدات معالجة الرسومات.', content_en: '<p>AMD is a leading semiconductor company...</p>', content_ar: '<p>AMD هي شركة رائدة في أشباه الموصلات...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['NVDA', 'INTC'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '9', ticker: 'AVGO', slug: 'broadcom-avgo', companyName_en: 'Broadcom Inc.', companyName_ar: 'شركة برودكوم', description_en: 'Broadcom designs semiconductors and infrastructure software.', description_ar: 'برودكوم تصمم أشباه الموصلات وبرمجيات البنية التحتية.', content_en: '<p>Broadcom is a global technology leader...</p>', content_ar: '<p>برودكوم هي شركة رائدة عالمياً في التكنولوجيا...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['NVDA', 'QCOM'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '10', ticker: 'LLY', slug: 'eli-lilly-lly', companyName_en: 'Eli Lilly and Company', companyName_ar: 'شركة إيلي ليلي', description_en: 'Eli Lilly develops pharmaceuticals for diabetes, oncology, and neuroscience.', description_ar: 'إيلي ليلي تطور الأدوية لمرض السكري والأورام.', content_en: '<p>Eli Lilly is a global pharmaceutical company...</p>', content_ar: '<p>إيلي ليلي هي شركة أدوية عالمية...</p>', sector: 'Healthcare', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['JNJ', 'MRK'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '11', ticker: 'JPM', slug: 'jpmorgan-jpm', companyName_en: 'JPMorgan Chase & Co.', companyName_ar: 'جي بي مورغان تشيس', description_en: 'JPMorgan is a leading global financial services firm.', description_ar: 'جي بي مورغان هي شركة خدمات مالية عالمية رائدة.', content_en: '<p>JPMorgan Chase & Co. is one of the largest banks...</p>', content_ar: '<p>جي بي مورغان تشيس هي واحدة من أكبر البنوك...</p>', sector: 'Financial Services', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['BAC', 'GS'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '12', ticker: 'UNH', slug: 'unitedhealth-unh', companyName_en: 'UnitedHealth Group Inc.', companyName_ar: 'مجموعة يونايتد هيلث', description_en: 'UnitedHealth is a healthcare and insurance company.', description_ar: 'يونايتد هيلث هي شركة رعاية صحية وتأمين.', content_en: '<p>UnitedHealth Group provides healthcare services...</p>', content_ar: '<p>مجموعة يونايتد هيلث تقدم خدمات الرعاية الصحية...</p>', sector: 'Healthcare', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['CVS', 'CI'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '13', ticker: 'V', slug: 'visa-v', companyName_en: 'Visa Inc.', companyName_ar: 'شركة فيزا', description_en: 'Visa is a global payments technology company.', description_ar: 'فيزا هي شركة تكنولوجيا مدفوعات عالمية.', content_en: '<p>Visa Inc. operates the world\'s largest payments network...</p>', content_ar: '<p>فيزا تدير أكبر شبكة مدفوعات في العالم...</p>', sector: 'Financial Services', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['MA', 'PYPL'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '14', ticker: 'MA', slug: 'mastercard-ma', companyName_en: 'Mastercard Incorporated', companyName_ar: 'ماستركارد', description_en: 'Mastercard is a global payment technology company.', description_ar: 'ماستركارد هي شركة تكنولوجيا دفع عالمية.', content_en: '<p>Mastercard provides payment processing services...</p>', content_ar: '<p>ماستركارد توفر خدمات معالجة الدفع...</p>', sector: 'Financial Services', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['V', 'PYPL'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '15', ticker: 'JNJ', slug: 'johnson-johnson-jnj', companyName_en: 'Johnson & Johnson', companyName_ar: 'جونسون آند جونسون', description_en: 'Johnson & Johnson develops pharmaceuticals and medical devices.', description_ar: 'جونسون آند جونسون تطور الأدوية والأجهزة الطبية.', content_en: '<p>Johnson & Johnson is a diversified healthcare company...</p>', content_ar: '<p>جونسون آند جونسون هي شركة رعاية صحية متنوعة...</p>', sector: 'Healthcare', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['PFE', 'MRK'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '16', ticker: 'COST', slug: 'costco-cost', companyName_en: 'Costco Wholesale Corporation', companyName_ar: 'كوستكو', description_en: 'Costco operates membership warehouse clubs.', description_ar: 'كوستكو تدير نوادي المستودعات للأعضاء.', content_en: '<p>Costco is one of the largest retailers...</p>', content_ar: '<p>كوستكو هي واحدة من أكبر شركات التجزئة...</p>', sector: 'Consumer Goods', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['WMT', 'TGT'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '17', ticker: 'WMT', slug: 'walmart-wmt', companyName_en: 'Walmart Inc.', companyName_ar: 'وولمارت', description_en: 'Walmart is the world\'s largest retailer.', description_ar: 'وولمارت هي أكبر شركة تجزئة في العالم.', content_en: '<p>Walmart operates retail stores...</p>', content_ar: '<p>وولمارت تدير متاجر التجزئة...</p>', sector: 'Consumer Goods', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['COST', 'TGT'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '18', ticker: 'PLTR', slug: 'palantir-pltr', companyName_en: 'Palantir Technologies Inc.', companyName_ar: 'بالانتير تكنولوجيز', description_en: 'Palantir builds software platforms for data integration and analytics.', description_ar: 'بالانتير تبني منصات برمجية لتحليل البيانات.', content_en: '<p>Palantir Technologies specializes in big data analytics...</p>', content_ar: '<p>بالانتير تكنولوجيز متخصصة في تحليلات البيانات الضخمة...</p>', sector: 'Technology', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['SNOW', 'CRM'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '19', ticker: 'MU', slug: 'micron-mu', companyName_en: 'Micron Technology, Inc.', companyName_ar: 'ميكرون تكنولوجي', description_en: 'Micron produces memory and storage solutions.', description_ar: 'ميكرون تنتج حلول الذاكرة والتخزين.', content_en: '<p>Micron Technology is a leader in memory products...</p>', content_ar: '<p>ميكرون تكنولوجي رائدة في منتجات الذاكرة...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['AMD', 'NVDA'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '20', ticker: 'INTC', slug: 'intel-intc', companyName_en: 'Intel Corporation', companyName_ar: 'شركة إنتل', description_en: 'Intel designs and manufactures semiconductor chips.', description_ar: 'إنتل تصمم وتصنع رقائق أشباه الموصلات.', content_en: '<p>Intel Corporation is a semiconductor company...</p>', content_ar: '<p>شركة إنتل هي شركة أشباه موصلات...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['AMD', 'NVDA'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '21', ticker: 'NFLX', slug: 'netflix-nflx', companyName_en: 'Netflix, Inc.', companyName_ar: 'نتفليكس', description_en: 'Netflix is a global streaming entertainment service.', description_ar: 'نتفليكس هي خدمة بث ترفيهي عالمية.', content_en: '<p>Netflix provides streaming media services...</p>', content_ar: '<p>نتفليكس توفر خدمات البث الإعلامي...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['DIS', 'WBD'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '22', ticker: 'ORCL', slug: 'oracle-orcl', companyName_en: 'Oracle Corporation', companyName_ar: 'أوراكل', description_en: 'Oracle provides enterprise software and cloud computing.', description_ar: 'أوراكل توفر برمجيات المؤسسات والحوسبة السحابية.', content_en: '<p>Oracle Corporation is a global cloud infrastructure provider...</p>', content_ar: '<p>شركة أوراكل هي مزود بنية تحتية سحابية عالمي...</p>', sector: 'Technology', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['MSFT', 'CRM'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '23', ticker: 'CRM', slug: 'salesforce-crm', companyName_en: 'Salesforce, Inc.', companyName_ar: 'سيلزفورس', description_en: 'Salesforce provides cloud-based CRM software.', description_ar: 'سيلزفورس توفر برمجيات إدارة علاقات العملاء السحابية.', content_en: '<p>Salesforce is the world\'s leading CRM platform...</p>', content_ar: '<p>سيلزفورس هي منصة CRM الرائدة في العالم...</p>', sector: 'Technology', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['ORCL', 'WDAY'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '24', ticker: 'ADBE', slug: 'adobe-adbe', companyName_en: 'Adobe Inc.', companyName_ar: 'أدوبي', description_en: 'Adobe provides creative and digital marketing software.', description_ar: 'أدوبي توفر البرمجيات الإبداعية والتسويق الرقمي.', content_en: '<p>Adobe Inc. is a leader in creative software...</p>', content_ar: '<p>أدوبي هي شركة رائدة في البرمجيات الإبداعية...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['CRM', 'INTU'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '25', ticker: 'GS', slug: 'goldman-sachs-gs', companyName_en: 'The Goldman Sachs Group, Inc.', companyName_ar: 'جولدمان ساكس', description_en: 'Goldman Sachs is a global investment banking and financial services company.', description_ar: 'جولدمان ساكس هي شركة خدمات مالية وبنكية استثمارية عالمية.', content_en: '<p>Goldman Sachs is a leading global investment bank...</p>', content_ar: '<p>جولدمان ساكس هي بنك استثماري عالمي رائد...</p>', sector: 'Financial Services', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['JPM', 'MS'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '26', ticker: 'COIN', slug: 'coinbase-coin', companyName_en: 'Coinbase Global, Inc.', companyName_ar: 'كوينباس', description_en: 'Coinbase is a cryptocurrency exchange platform.', description_ar: 'كوينباس هي منصة تداول العملات المشفرة.', content_en: '<p>Coinbase is the largest cryptocurrency exchange in the US...</p>', content_ar: '<p>كوينباس هي أكبر منصة تداول عملات مشفرة في أمريكا...</p>', sector: 'Financial Services', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['HOOD', 'SQ'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '27', ticker: 'HOOD', slug: 'robinhood-hood', companyName_en: 'Robinhood Markets, Inc.', companyName_ar: 'روبنهود', description_en: 'Robinhood is a commission-free trading platform.', description_ar: 'روبنهود هي منصة تداول بدون عمولة.', content_en: '<p>Robinhood democratized investing...</p>', content_ar: '<p>روبنهود أتاحت الاستثمار للجميع...</p>', sector: 'Financial Services', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['COIN', 'SCHW'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '28', ticker: 'SOFI', slug: 'sofi-sofi', companyName_en: 'SoFi Technologies, Inc.', companyName_ar: 'سوفي', description_en: 'SoFi provides digital financial services.', description_ar: 'سوفي توفر خدمات مالية رقمية.', content_en: '<p>SoFi Technologies is a digital finance company...</p>', content_ar: '<p>سوفي تكنولوجيز هي شركة تمويل رقمي...</p>', sector: 'Financial Services', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['HOOD', 'COIN'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '29', ticker: 'BA', slug: 'boeing-ba', companyName_en: 'The Boeing Company', companyName_ar: 'بوينغ', description_en: 'Boeing designs and manufactures commercial airplanes.', description_ar: 'بوينغ تصمم وتصنع الطائرات التجارية.', content_en: '<p>Boeing is a leading aerospace company...</p>', content_ar: '<p>بوينغ هي شركة طيران رائدة...</p>', sector: 'Industrials', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['LMT', 'RTX'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '30', ticker: 'MSTR', slug: 'microstrategy-mstr', companyName_en: 'MicroStrategy Incorporated', companyName_ar: 'مايكروستراتيجي', description_en: 'MicroStrategy provides business intelligence software and holds Bitcoin.', description_ar: 'مايكروستراتيجي توفر برمجيات ذكاء الأعمال وتحتفظ بالبيتكوين.', content_en: '<p>MicroStrategy is an enterprise analytics company...</p>', content_ar: '<p>مايكروستراتيجي هي شركة تحليلات مؤسسية...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['COIN', 'SQ'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '31', ticker: 'RKLB', slug: 'rocket-lab-rklb', companyName_en: 'Rocket Lab USA, Inc.', companyName_ar: 'روكيت لاب', description_en: 'Rocket Lab provides launch and space systems.', description_ar: 'روكيت لاب توفر خدمات الإطلاق وأنظمة الفضاء.', content_en: '<p>Rocket Lab is a leader in small satellite launches...</p>', content_ar: '<p>روكيت لاب رائدة في إطلاق الأقمار الصناعية الصغيرة...</p>', sector: 'Industrials', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['SPCE', 'ASTR'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '32', ticker: 'LRCX', slug: 'lam-research-lrcx', companyName_en: 'Lam Research Corporation', companyName_ar: 'لام ريسيرتش', description_en: 'Lam Research provides semiconductor manufacturing equipment.', description_ar: 'لام ريسيرتش توفر معدات تصنيع أشباه الموصلات.', content_en: '<p>Lam Research is a leading semiconductor equipment company...</p>', content_ar: '<p>لام ريسيرتش رائدة في معدات أشباه الموصلات...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['AMAT', 'KLAC'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '33', ticker: 'AMAT', slug: 'applied-materials-amat', companyName_en: 'Applied Materials, Inc.', companyName_ar: 'أبلايد ماتيريالز', description_en: 'Applied Materials provides equipment for semiconductor manufacturing.', description_ar: 'أبلايد ماتيريالز توفر معدات لتصنيع أشباه الموصلات.', content_en: '<p>Applied Materials is a semiconductor equipment company...</p>', content_ar: '<p>أبلايد ماتيريالز هي شركة معدات أشباه الموصلات...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['LRCX', 'KLAC'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '34', ticker: 'CVNA', slug: 'carvana-cvna', companyName_en: 'Carvana Co.', companyName_ar: 'كارفانا', description_en: 'Carvana is an e-commerce platform for used cars.', description_ar: 'كارفانا هي منصة تجارة إلكترونية للسيارات المستعملة.', content_en: '<p>Carvana provides an online car buying experience...</p>', content_ar: '<p>كارفانا توفر تجربة شراء سيارات عبر الإنترنت...</p>', sector: 'Consumer Goods', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['TSLA', 'F'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '35', ticker: 'GEV', slug: 'ge-vernova-gev', companyName_en: 'GE Vernova Inc.', companyName_ar: 'جي إي فيرنوفا', description_en: 'GE Vernova provides energy transition and power solutions.', description_ar: 'جي إي فيرنوفا توفر حلول انتقال الطاقة والكهرباء.', content_en: '<p>GE Vernova focuses on sustainable energy...</p>', content_ar: '<p>جي إي فيرنوفا تركز على الطاقة المستدامة...</p>', sector: 'Energy', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['NEE', 'ENPH'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '36', ticker: 'ASTS', slug: 'ast-spacemobile-asts', companyName_en: 'AST SpaceMobile, Inc.', companyName_ar: 'إيه إس تي سبيس موبايل', description_en: 'AST SpaceMobile builds a space-based cellular network.', description_ar: 'إيه إس تي سبيس موبايل تبني شبكة خلوية فضائية.', content_en: '<p>AST SpaceMobile is building the first space-based cellular network...</p>', content_ar: '<p>إيه إس تي سبيس موبايل تبني أول شبكة خلوية فضائية...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['RKLB', 'SPCE'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '37', ticker: 'CRWD', slug: 'crowdstrike-crwd', companyName_en: 'CrowdStrike Holdings, Inc.', companyName_ar: 'كراود سترايك', description_en: 'CrowdStrike provides cloud-delivered cybersecurity.', description_ar: 'كراود سترايك توفر الأمن السيبراني السحابي.', content_en: '<p>CrowdStrike is a leader in cloud security...</p>', content_ar: '<p>كراود سترايك رائدة في أمان السحابة...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['PANW', 'ZS'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '38', ticker: 'IBM', slug: 'ibm-ibm', companyName_en: 'International Business Machines Corporation', companyName_ar: 'آي بي إم', description_en: 'IBM provides hybrid cloud and AI solutions.', description_ar: 'آي بي إم توفر حلول السحابة الهجينة والذكاء الاصطناعي.', content_en: '<p>IBM is a global technology company...</p>', content_ar: '<p>آي بي إم هي شركة تكنولوجيا عالمية...</p>', sector: 'Technology', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['MSFT', 'ORCL'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '39', ticker: 'MRVL', slug: 'marvell-mrvl', companyName_en: 'Marvell Technology, Inc.', companyName_ar: 'مارفل تكنولوجي', description_en: 'Marvell designs semiconductor solutions for data infrastructure.', description_ar: 'مارفل تصمم حلول أشباه الموصلات للبنية التحتية للبيانات.', content_en: '<p>Marvell Technology is a semiconductor company...</p>', content_ar: '<p>مارفل تكنولوجي هي شركة أشباه موصلات...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['AVGO', 'NVDA'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '40', ticker: 'WDAY', slug: 'workday-wday', companyName_en: 'Workday, Inc.', companyName_ar: 'ووركداي', description_en: 'Workday provides enterprise cloud applications for finance and HR.', description_ar: 'ووركداي توفر تطبيقات سحابية للمؤسسات للمالية والموارد البشرية.', content_en: '<p>Workday is a leader in enterprise software...</p>', content_ar: '<p>ووركداي رائدة في برمجيات المؤسسات...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['CRM', 'NOW'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '41', ticker: 'PANW', slug: 'palo-alto-panw', companyName_en: 'Palo Alto Networks, Inc.', companyName_ar: 'بالو ألتو نتوركس', description_en: 'Palo Alto Networks provides cybersecurity solutions.', description_ar: 'بالو ألتو نتوركس توفر حلول الأمن السيبراني.', content_en: '<p>Palo Alto Networks is a cybersecurity leader...</p>', content_ar: '<p>بالو ألتو نتوركس رائدة في الأمن السيبراني...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['CRWD', 'ZS'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '42', ticker: 'TMO', slug: 'thermo-fisher-tmo', companyName_en: 'Thermo Fisher Scientific Inc.', companyName_ar: 'ثيرمو فيشر ساينتيفيك', description_en: 'Thermo Fisher provides scientific instruments and laboratory equipment.', description_ar: 'ثيرمو فيشر توفر الأدوات العلمية ومعدات المختبرات.', content_en: '<p>Thermo Fisher Scientific is a leader in life sciences...</p>', content_ar: '<p>ثيرمو فيشر ساينتيفيك رائدة في علوم الحياة...</p>', sector: 'Healthcare', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['DHR', 'A'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '43', ticker: 'CSCO', slug: 'cisco-csco', companyName_en: 'Cisco Systems, Inc.', companyName_ar: 'سيسكو', description_en: 'Cisco provides networking and IT infrastructure solutions.', description_ar: 'سيسكو توفر حلول الشبكات والبنية التحتية لتكنولوجيا المعلومات.', content_en: '<p>Cisco Systems is a leader in networking equipment...</p>', content_ar: '<p>سيسكو سيستمز رائدة في معدات الشبكات...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['JNPR', 'ANET'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '44', ticker: 'BE', slug: 'bloom-energy-be', companyName_en: 'Bloom Energy Corporation', companyName_ar: 'بلوم إنرجي', description_en: 'Bloom Energy provides solid oxide fuel cell power solutions.', description_ar: 'بلوم إنرجي توفر حلول طاقة خلايا الوقود الصلب.', content_en: '<p>Bloom Energy is a clean energy company...</p>', content_ar: '<p>بلوم إنرجي هي شركة طاقة نظيفة...</p>', sector: 'Energy', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['PLUG', 'FCEL'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '45', ticker: 'CVX', slug: 'chevron-cvx', companyName_en: 'Chevron Corporation', companyName_ar: 'شيفرون', description_en: 'Chevron is an integrated energy company.', description_ar: 'شيفرون هي شركة طاقة متكاملة.', content_en: '<p>Chevron Corporation is one of the world\'s largest oil companies...</p>', content_ar: '<p>شركة شيفرون هي واحدة من أكبر شركات النفط في العالم...</p>', sector: 'Energy', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['XOM', 'COP'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '46', ticker: 'MRK', slug: 'merck-mrk', companyName_en: 'Merck & Co., Inc.', companyName_ar: 'ميرك', description_en: 'Merck is a global pharmaceutical company.', description_ar: 'ميرك هي شركة أدوية عالمية.', content_en: '<p>Merck & Co. is a leading pharmaceutical company...</p>', content_ar: '<p>ميرك آند كو هي شركة أدوية رائدة...</p>', sector: 'Healthcare', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['JNJ', 'PFE'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '47', ticker: 'CRWV', slug: 'cerebras-crwv', companyName_en: 'Cerebras Systems', companyName_ar: 'سيريبراس', description_en: 'Cerebras builds AI computing systems.', description_ar: 'سيريبراس تبني أنظمة حوسبة الذكاء الاصطناعي.', content_en: '<p>Cerebras Systems develops AI accelerators...</p>', content_ar: '<p>سيريبراس سيستمز تطور مسرعات الذكاء الاصطناعي...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['NVDA', 'AMD'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '48', ticker: 'APP', slug: 'applovin-app', companyName_en: 'AppLovin Corporation', companyName_ar: 'آبلوفين', description_en: 'AppLovin provides software solutions for mobile app developers.', description_ar: 'آبلوفين توفر حلول برمجية لمطوري تطبيقات الجوال.', content_en: '<p>AppLovin is a mobile technology company...</p>', content_ar: '<p>آبلوفين هي شركة تكنولوجيا الجوال...</p>', sector: 'Technology', exchange: 'NASDAQ', status: 'published', seo: {}, relatedTickers: ['U', 'TTD'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '49', ticker: 'SNAP', slug: 'snap-snap', companyName_en: 'Snap Inc.', companyName_ar: 'سناب', description_en: 'Snap is a camera and social media company.', description_ar: 'سناب هي شركة كاميرا ووسائل التواصل الاجتماعي.', content_en: '<p>Snap Inc. operates Snapchat...</p>', content_ar: '<p>سناب تدير سناب شات...</p>', sector: 'Technology', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['META', 'PINS'], publishedAt: now, createdAt: now, updatedAt: now },
  { id: '50', ticker: 'PINS', slug: 'pinterest-pins', companyName_en: 'Pinterest, Inc.', companyName_ar: 'بينتريست', description_en: 'Pinterest is a visual discovery and bookmarking platform.', description_ar: 'بينتريست هي منصة اكتشاف بصري وحفظ الإشارات المرجعية.', content_en: '<p>Pinterest operates a visual discovery platform...</p>', content_ar: '<p>بينتريست تدير منصة اكتشاف بصري...</p>', sector: 'Technology', exchange: 'NYSE', status: 'published', seo: {}, relatedTickers: ['META', 'SNAP'], publishedAt: now, createdAt: now, updatedAt: now },
];
