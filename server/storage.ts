    ...
    const defaultSchemaBlockDefinitions: SchemaBlockDefinition[] = [
      {
        ...
        defaultSchemaJson: { title: { required: true }, subtitle: { required: false }, body: { required: false } },
      ...
      },
      {
        ...
        defaultSchemaJson: { title: { required: true }, articles: { required: true, minItems: 1 } },
      ...
      },
      {
        ...
        defaultSchemaJson: { title: { required: true }, stocks: { required: true, minItems: 1 } },
      ...
      },
      {
        ...
        defaultSchemaJson: { title: { required: true }, ticker: { required: true } },
      ...
      },
      {
        ...
        defaultSchemaJson: { term: { required: true }, definition: { required: true } },
      ...
      },
      {
        ...
        defaultSchemaJson: { title: { required: true }, newsItems: { required: true, minItems: 1 } },
      ...
      },
      {
        ...
        defaultSchemaJson: { title: { required: true }, buttonText: { required: true }, buttonUrl: { required: true } },
