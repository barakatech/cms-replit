  ...
  useEffect(() => {
    if (stockPage) {
      form.reset({
        ...
        metaTitle_en: stockPage.seo?.metaTitle_en || '',
        metaTitle_ar: stockPage.seo?.metaTitle_ar || '',
        metaDescription_en: stockPage.seo?.metaDescription_en || '',
        metaDescription_ar: stockPage.seo?.metaDescription_ar || '',
